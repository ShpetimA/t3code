    ...
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          ...
          description="Choose a persistent left sidebar or a global tab strip for threads, settings, Usage, and Pull Requests. Top tabs are used on wide screens; compact layouts keep the sidebar."
          resetAction={
