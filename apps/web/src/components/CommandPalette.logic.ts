...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "search-threads";
}
...
export type CommandPaletteUiAction =
  ...
  | { readonly _tag: "OpenSearchThreads" }
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenSearchThreads":
      return { open: true, mode: "command", openIntent: { kind: "search-threads" } };
