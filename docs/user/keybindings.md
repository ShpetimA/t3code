...
`editor.toggleFocus` expands the active editor group to fill the workspace and restores the split
layout when pressed again. It defaults to `mod+shift+enter`.
